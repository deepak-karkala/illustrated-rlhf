...
export const MODULES: ModuleNavItem[] = [
  ...
  {
    id: 'module-regularization',
    slug: 'regularization',
    title: 'Regularization & KL Control',
    description: 'Tame over-optimisation with KL penalties and auxiliary losses',
    phase: 'phase-2',
    analogy: 'advanced',
    prerequisites: ['module-problem-setup', 'module-reward-modeling'],
    estimated_time: 30,
    difficulty: 'intermediate',
    tags: ['regularization', 'kl'],
    summary: 'Study KL divergence, entropy bonuses, and auxiliary losses that keep RLHF stable.',
    order: 4,
    progress: 0,
    status: 'available',
    sections: [
      {
        id: 'equation',
        type: 'equation',
        title: 'KL Regularised Objective',
        eyebrow: 'Equation',
      },
      {
        id: 'intuition',
        type: 'intuition',
        title: 'Controlling Over-Optimisation',
        eyebrow: 'Intuition',
      },
      {
        id: 'analogy',
        type: 'analogy',
        title: 'Analogy: Safety Harness for RLHF',
        eyebrow: 'Analogy',
      },
      {
        id: 'visualization',
        type: 'visualization',
        title: 'Regularisation Lab',
        eyebrow: 'Visualization',
      },
      {
        id: 'takeaways',
      ...
      },
      {
        id: 'assessment',
        type: 'assessment',
        title: 'Regularisation Check',
        eyebrow: 'Assessment',
      },
    ],
  },
  {
    id: 'module-rejection-sampling',
    slug: 'rejection-sampling',
    title: 'Rejection Sampling',
    description: 'Baseline preference filtering with reward models',
    phase: 'phase-2',
    analogy: 'writing',
    prerequisites: ['module-instruction-tuning', 'module-reward-modeling'],
    estimated_time: 30,
    difficulty: 'intermediate',
    tags: ['rejection-sampling', 'baseline'],
    summary:
    ...
    sections: [
      ...
      },
      {
        id: 'intuition',
        type: 'intuition',
        title: 'Why Rejection Sampling Works',
        eyebrow: 'Intuition',
      },
      {
        id: 'analogy',
        type: 'analogy',
        title: 'Analogy: Editor’s Slush Pile',
        eyebrow: 'Analogy',
      },
      {
        id: 'visualization',
      ...
      },
      {
        id: 'assessment',
        type: 'assessment',
        title: 'Rejection Sampling Check',
        eyebrow: 'Assessment',
      },
    ],
  },
